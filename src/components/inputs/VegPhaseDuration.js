...
const VegPhaseDuration = ({ translation, icons, isDarkmode, colors,theme,
  ...
  return (
    <View style={styles.phaseInput}>
      ...
      <TextInput
        ...
        value={growObject.veggingDurationInDays}
        style={[styles.textInput, inputStyles]}
        onChangeText={text => {
          setGrowObject(prevState => ({...prevState, veggingDurationInDays:text}));
        }}
      />
    </View>
  );
...
export default VegPhaseDuration;
